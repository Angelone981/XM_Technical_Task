...
def Html_body():
    ...
    sstr = """ <html lang="en"><!-- Created by Paul Hallett - http://phalt.co Maintained by Juriy Bura - https://github.com/juriy --><head>
    <meta charset="utf-8">
    <title>
...
<script>
  ...
  <div class="row">
        <div class="col-lg-12 footer">
          ...
          Maintained by Juriy Bura ©<script type="text/javascript">document.write(new Date().getFullYear());</script>2023 
          <span class="pull-right">
            <iframe id="twitter-widget-0" scrolling="no" allowtransparency="true" allowfullscreen="true" class="twitter-follow-button twitter-follow-button-rendered" style="position: static; visibility: visible; width: 77px; height: 20px;" title="Twitter Follow Button" src="https://platform.twitter.com/widgets/follow_button.2b2d73daf636805223fb11d48f3e94f7.en.html#dnt=true&amp;id=twitter-widget-0&amp;lang=en&amp;screen_name=juriy&amp;show_count=false&amp;show_screen_name=false&amp;size=m&amp;time=1675424178917" data-screen-name="juriy" frameborder="0"></iframe>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
          <iframe src="//ghbtns.com/github-btn.html?user=juriy&amp;type=follow" allowtransparency="false" scrolling="0" width="132" height="20" frameborder="0"></iframe></span><p></p>
          </div>
      </div>
  

</div><iframe scrolling="no" allowtransparency="true" src="https://platform.twitter.com/widgets/widget_iframe.2b2d73daf636805223fb11d48f3e94f7.html?origin=https%3A%2F%2Fswapi.dev" title="Twitter settings iframe" style="display: none;" frameborder="0"></iframe><iframe id="rufous-sandbox" scrolling="no" allowtransparency="true" allowfullscreen="true" style="position: absolute; visibility: hidden; display: none; width: 0px; height: 0px; padding: 0px; border: medium none;" title="Twitter analytics iframe" frameborder="0"></iframe></body></html> """
